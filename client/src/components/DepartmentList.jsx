...
const DepartmentList = ({ departments = [], onDelete, onEdit, loading, error }) => {
  if (loading) {
    return (
  ...
  if (!departments.length) {
    return (
      <div className="text-center py-8">
        ...
        <Link to="/departments/add" className="mt-4 inline-block bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700">
        ...
        <tbody className="divide-y divide-gray-200">
          {departments.map((department) => (
            <tr key={department.id} className="hover:bg-gray-50">
              ...
              <td className="py-3 px-4">{department.location}</td>
